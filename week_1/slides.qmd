...
- Aim: Want a process that is robust and rigourous end-to-end, not just in the statistical analysis part. This will enable transparent, efficient, and trustworthy research.
...
- Statistics, which you've hopefully taken a course or two in, is one aspect of that. Modelling has very rigourous approaches once we have a dataset. Experimental design has very rigourous approach for how we should get data. etc etc etc. 
